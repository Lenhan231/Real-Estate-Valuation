...
TEXT_FEATURE_PATTERNS = {
    "is_hem_xe_hoi": ["hẻm xe hơi", "hxh", "ô tô", "xe hơi", "mặt ngõ"],
    "is_mat_tien": ["mặt tiền", "mặt phố"],
    "is_no_hau": ["nở hậu"],
    "has_noi_that": ["nội thất", "full", "đầy đủ", "cho thuê"],
    "is_gap": ["gấp", "giảm giá", "cần bán"],
    "is_kinh_doanh": ["kinh doanh", "cho thuê", "thu nhập"],
}
